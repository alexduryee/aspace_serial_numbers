{
  :schema => {
    ...
    "properties" => {
      ...
      "id_0" => {"type" => "string", "maxLength" => 255, "ifmissing" => "error"},
      ...
      "lang_materials" => {"type" => "array", "minItems" => 0, "items" => {"type" => "JSONModel(:lang_material) object"}},

      # Extents (overrides abstract schema)
      # don't require this for collections
